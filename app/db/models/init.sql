...
("Bush lily", "Coming forward its flower, Bush lily decorates mostly indoors such as conservatory, closed places, and so forth.", 20, 9.99, 0.5, 23, 60, 31, now(), now()),
("Snakeplant", "If a prize were available for the most tolerant plant, snake plant (Sansevieria) would certainly be one of the frontrunners.", 20, 15.99, 0.7, 25, 20, 11, now(), now()),
("Cushon Bush", "Cushion bush, also known as silver bush (Leucophyta brownii) is a very tough and attractive perennial, native to Australia. It’s very popular in pots, borders and larger clumps in the garden.", 20, 12.99, 0.4, 10, 15, 31, now(), now()),
("Joseph's Coat", "Codiaeum variegatum is the scientific name for the plant also named variegated croton. This plant demand quite a lot of care and attention, which makes them not the easiest to grow.", 20, 8.99, 0.3, 10, 15, 31, now(), now())
;
